...
import 'package:eshop_multivendor/Screen/tiffin_plan.dart';
  ...
  _getDrawer() {
    return ListView(
      ...
      children: <Widget>[
        ...
        CUR_USERID == "" || CUR_USERID == null
            ? Container()
            : _getDrawerItem(getTranslated(context, 'ORDER_TIFFIN_LBL')!,
            'assets/images/tiffinIcon.svg'),
        CUR_USERID == "" || CUR_USERID == null
            ? Container()
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          }else if (title == getTranslated(context, 'ORDER_TIFFIN_LBL')) {
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => TiffinPlansView(),
                ));
